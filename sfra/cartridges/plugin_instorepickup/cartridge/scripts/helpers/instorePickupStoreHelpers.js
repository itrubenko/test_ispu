 ...
 */
function setStoreInProductLineItem(storeId, productLineItem, req) {
    Transaction.wrap(function () {
        if (storeId) {
            productLineItem.custom.fromStoreId = storeId; // eslint-disable-line
            productLineItem.custom.storeInfo = req.form.storeInfo; // eslint-disable-line
            // no-param-reassign
