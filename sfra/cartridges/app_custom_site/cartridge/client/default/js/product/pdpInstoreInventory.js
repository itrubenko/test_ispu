...
function getModalHtmlElement() {
    ...
    var htmlString = '<!-- Modal -->'
        ...
        + '<div class="modal-dialog in-store-inventory-dialog modal-lg">'
        + '<!-- Modal content-->'
...
function updateQuantityOptions(searchPID, storeId) {
    ...
    var storeInfo = $('.js-store').find('input[value='+ storeId +']').data('storeInfo');
    var requestData = {
...
module.exports = {
        ...
        $('body').on('updateAddToCartFormData', function (e, form) {
            ...
            if ($(storeElement).length) {
                form.storeId = $(storeElement).find('.store-name') // eslint-disable-line
                    .attr('data-store-id');
                form.storeInfo = $(storeElement).find('.store-name') // eslint-disable-line
                .attr('data-store-info')
            }
        });
    },
    ...
    selectStoreWithInventory: function () {
        $('body').on('store:selected', function (e, data) {
            ...
            var storeInfo = $('.js-store').find('input[value='+ data.storeID +']').data('storeInfo');
            $(storeElement).find('.store-name').attr('data-store-info', JSON.stringify(storeInfo));
